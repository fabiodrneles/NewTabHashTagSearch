...
const Home = () => {
    ...
    // Obtem o Timestamp no qual a hashtag foi pesquisada
    function timeStamp() {
        const now = new Date();
        return now.getTime();
    }

    // Define o link da API para salvar as informações de hashtag necessárias
    function getAirtableURL() {
        return 'https://api.airtable.com/v0/app6wQWfM6eJngkD4/Buscas';
        
    }

    // Salva todas as informações necessárias após a pesquisa da hashtag.
